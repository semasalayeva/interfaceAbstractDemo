...
public class CHCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CHCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CHCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CHCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CHCDateTimeConverter dateTimeConverter = new CHCStandardDateTimeConverter();

    public CHCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CHCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CHCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=CHCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CHCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=CHCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
