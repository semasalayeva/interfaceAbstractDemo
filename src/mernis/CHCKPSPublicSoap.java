...
public class CHCKPSPublicSoap
{
    ...
    public CHCKPSPublicSoap(){}

    public CHCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CHCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CHCExtendedSoapSerializationEnvelope envelope= new CHCExtendedSoapSerializationEnvelope(CHCExtendedSoapSerializationEnvelope.VER11);
